...
import { confUnaryRule, confUnaryOp } from '../rules/operator/unary';
...
import { confIdentifierRule, confIdentifierChars } from '../rules/token/identifier';
...
export const es5PreUnaryOp: confUnaryOp[] = [
  {
    '-': UNARY_TYPE,
    '+': UNARY_TYPE,
    '!': UNARY_TYPE,
...
export function es5IdentifierConf(identifier?: confIdentifierChars, newRule?: { rules?: BaseRule[][], level?: number }): confIdentifierRule {
  return {
    literals: {
      'true': true,
      'false': false,
